...
~~~sh
# getting the code
git clone git@github.com:nko4/synth.git && cd ./synth/

# developing
npm install
npm start

# deploying (to http://synth.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@synth.2013.nodeknockout.com
ssh root@synth.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@synth.2013.nodeknockout.com
ssh -i ./id_deploy root@synth.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/synth" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
